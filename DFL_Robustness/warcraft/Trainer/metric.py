...
def fooling_regret(true_weights, true_paths, adv_suggested_paths, suggested_paths ,minimize=True):
    ...
    regret = mm*(( suggested_paths_costs - true_paths_costs)/true_paths_costs)
    
    adv_suggested_paths_costs = (adv_suggested_paths * true_weights).sum((1,2))
    true_paths_costs = (true_paths * true_weights).sum((1,2))
    adv_regret = mm*(( adv_suggested_paths_costs - true_paths_costs)/true_paths_costs)
    
    return l1_loss(adv_regret,regret), l2_loss(adv_regret,regret)
